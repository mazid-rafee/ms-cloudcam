...
class Cloudsen12l1cDataloader(Dataset):
    def __init__(self, indices, selected_bands):
        ...
        taco_path = os.path.join(base_dir, "..", "..", "data", "CloudSen12+", "TACOs", "mini-cloudsen12-l1c-high-512.taco")
...
def get_cloudsen12_datasets(selected_bands, split_ratio=(0.7, 0.15, 0.15)):
    ...
    train_ds = Cloudsen12l1cDataloader(train_indices, selected_bands)
    val_ds = Cloudsen12l1cDataloader(val_indices, selected_bands)
    test_ds = Cloudsen12l1cDataloader(test_indices, selected_bands)
