...
# Visualization
# -------------------------
def visualize_sample_l8biome(model, dataset, idx, ckpt_path, out_dir="outputs_l8biome"):
...
if __name__ == "__main__":
    ...
    _, _, test_set = get_l8biome_datasets([3, 4, 9], 512, 512, split_ratio=(0.85, 0.05, 0.1))

    # Path to checkpoint
    ckpt = "src/results/checkpoints/upernet_internimage_dcnv4_l8biome.pth"

    # Visualize one sample (change idx as needed)
    visualize_sample_l8biome(model, test_set, idx=869, ckpt_path=ckpt)
