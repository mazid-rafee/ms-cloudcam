...
RESULTS_TXT = "results/Deeplabv3_Unet_CloudSen12_l2a.txt"
EPOCHS = 100
BS = 8
LR = 1e-3
NUM_WORKERS = 4
...
def train_and_test(arch_name, encoder_name, encoder_weights, bands):
    ...
    best_val = float("inf")
    ckpt_best = f"results/best_{arch_name}_{encoder_name}_cloudsen12_l2a.pth"
    ckpt_last = f"results/last_{arch_name}_{encoder_name}_cloudsen12_l2a.pth"
