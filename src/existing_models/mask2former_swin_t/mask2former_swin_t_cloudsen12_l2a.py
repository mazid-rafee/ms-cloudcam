...
if __name__ == "__main__":
    ...
    for epoch in range(100):
        ...
        if val_loss < best_val_loss:
            ...
            torch.save(model.state_dict(), "results/best_model_mask2former_swin_t_cloudsen12_l2a.pth")
        
        torch.save(model.state_dict(), "results/last_model_mask2former_swin_t_cloudsen12_l2a.pth")

    print("\n=== Evaluating Best Model mask2former_swin_t_cloudsen12_l2a ===")
    model.load_state_dict(torch.load("results/best_model_mask2former_swin_t_cloudsen12_l2a.pth"))
    evaluate_test(model, test_loader)

    print("\n=== Evaluating Last Model mask2former_swin_t_cloudsen12_l2a ===")
    model.load_state_dict(torch.load("results/last_model_mask2former_swin_t_cloudsen12_l2a.pth"))
    evaluate_test(model, test_loader)
