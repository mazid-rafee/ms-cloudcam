...
if __name__ == "__main__":
    ...
    for epoch in range(100):
        ...
        if val_loss < best_val_loss:
            ...
            torch.save(model.state_dict(), "results/best_model_mask2former_dinov2_cloudsen12.pth")
        
        torch.save(model.state_dict(), "results/last_model_mask2former_dinov2_cloudsen12.pth")

    print("\n=== Evaluating Best Model mask2former_dinov2_cloudsen12 ===")
    model.load_state_dict(torch.load("results/best_model_mask2former_dinov2_cloudsen12.pth"))
    best_results = evaluate_test(model, test_loader)

    print("\n=== Evaluating Last Model mask2former_dinov2_cloudsen12 ===")
    model.load_state_dict(torch.load("results/last_model_mask2former_dinov2_cloudsen12.pth"))
